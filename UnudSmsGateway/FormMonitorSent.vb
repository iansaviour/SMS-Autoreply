...
Public Class FormMonitorSent
    Private Sub FormMonitorSent_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub view_list()
        Dim query As String = "SELECT tb_operasi_in.id_op_in, DATE(tb_operasi_in.datetime) AS date, TIME(tb_operasi_in.datetime) AS time, tb_operasi_in.message_in AS message, tb_operasi_in.no_hp, tb_operasi.nama_operasi AS operasi FROM tb_operasi_in, tb_operasi, tb_operasi_in_data WHERE tb_operasi_in_data.id_op_in = tb_operasi_in.id_op_in AND tb_operasi.id_operasi = tb_operasi_in.id_operasi ORDER BY tb_operasi_in.datetime DESC"
        ...
        If GVRequest.RowCount > 0 Then
            Dim id_op_in As String = GVRequest.GetFocusedRowCellDisplayText("id_op_in").ToString

            view_partner(id_op_in)
        Else
        ...
        End If
    End Sub
    Public Sub view_partner(ByVal id_op_in As String)
        Dim query2 As String = String.Format("SELECT sent_data, format FROM tb_operasi_in_data WHERE id_op_in = '{0}'", id_op_in)
        ...
        If data_temp.Rows(0)("sent_data").ToString.Substring(0, 7) = "Error :" Or data_temp.Rows(0)("sent_data").ToString.Substring(0, 8) = "Sukses :" Or data_temp.Rows(0)("sent_data").ToString.Length < 7 Then
            formatx = 0
        End If
        ...
        If formatx.ToString = "1" Then
            ...
            koneksi.Open()
            query_ID = "SELECT tb_host.karakter_pemisah FROM tb_operasi,tb_host,tb_operasi_in WHERE tb_operasi_in.id_operasi = tb_operasi.id_operasi AND tb_operasi.id_host = tb_host.id_host AND id_op_in='" & id_op_in & "'"
            ...
            data_reply = data_temp.Rows(0)("sent_data").ToString
            p = 1
        ...
        Else
            ...
            For i As Integer = 0 To data_temp.Rows.Count - 1
                data.Rows.Add(data_temp.Rows(i)("sent_data").ToString)
            Next
    ...
    Private Sub BDeleteInbox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BDeleteInbox.Click
        ...
        If confirm = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                Dim id_op_in As String = GVRequest.GetFocusedRowCellDisplayText("id_op_in").ToString
                Dim query As String = String.Format("DELETE tb_operasi_in, tb_operasi_in_data FROM tb_operasi_in, tb_operasi_in_data WHERE tb_operasi_in.id_op_in = tb_operasi_in_data.id_op_in AND tb_operasi_in.id_op_in = '{0}'", id_op_in)
    ...
    Private Sub BPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BPrint.Click
        print(GCRequest, "Log Remote Sent")
    End Sub
