...
Public Class FormSettingHostPartner
    Private Sub FormSettingHostPartner_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        refresh_host()
    End Sub
    Sub refresh_host()
        Dim koneksi As New MySqlConnection(conn_db)
        Dim data As New DataSet
        Dim query As String = "SELECT nama_host as 'Nama Host',id_host,no_hp as 'Nomor Kontak',email as 'E-mail',karakter_pemisah as 'String Pemisah' FROM tb_host WHERE is_local=0"
